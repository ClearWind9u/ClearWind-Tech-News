        ...
        >
          <div>
            ...
            <div className="space-y-2.5 mb-5 p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/5">
              <div className="text-[11px] font-mono font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                <span>{t.keyTakeaways}</span>
              </div>
              <ul className="space-y-2 border-l-2 border-emerald-500/30 dark:border-emerald-500/20 pl-3">
                {leadSummary.slice(0, 3).map((point, idx) => (
                  <li key={idx} className="text-xs sm:text-[13px] text-slate-600 dark:text-slate-300 leading-relaxed">
